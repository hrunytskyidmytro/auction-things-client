          ...
          <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12} sx={{ mt: 15 }}>
              <Breadcrumbs
                links={[
                  { label: "Лоти", url: "/lots" },
                  { label: "Додавання нового лоту", url: `/lots/seller/new` },
                ]}
              />
            </Grid>
            <Grid item xs={12}>
              ...
              >
                <Typography variant="body2" textAlign={"center"}>
                  При редагуванні, зображення змінювати не можна. Намагайтеся
                  зображення встановлювати на початку.
                </Typography>
                <Formik
                  initialValues={{
                    title: "",
                  ...
                  {({ errors, touched, isSubmitting }) => (
                    <Form>
                      ...
                      <Field
                        ...
                        error={
                          touched.startingPrice && Boolean(errors.startingPrice)
                        }
                      ...
                      <Field
                        ...
                        error={
                          touched.buyNowPrice && Boolean(errors.buyNowPrice)
                        }
                      ...
                      <Field
                        ...
                        error={
                          touched.bidIncrement && Boolean(errors.bidIncrement)
                        }
                      ...
                      <Field
                        ...
                        error={
                          touched.reservePrice && Boolean(errors.reservePrice)
                        }
